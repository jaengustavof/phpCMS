...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="nav-link" href="frontIndex.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                ...
                                                $queryTotalUsers = mysqli_query($conectar, $sqlTotalUsers);
                                                while($rowTotalUsers = mysqli_fetch_assoc($queryTotalUsers)){
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">'.$rowTotalUsers['total_users'].'</div>';
                                                }
                                            ?>
                ...
                if($_SESSION['roleUser'] == 1){
                    echo '<h1>Welcome '.$_SESSION['nameUser'].' !</h1><br>';
                    include "users.php";
                }else{
                    echo '<h1>Welcome '.$_SESSION['nameUser'].' !</h1><br>';
                }
